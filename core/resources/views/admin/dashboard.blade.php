    ...
    <div class="row gy-4 mt-2">
        <div class="col-xxl-3 col-sm-6">
            <x-widget
                ...
                title="Total Invest"
                value="{{ showAmount($widget['total_invest']) }}"
                bg="info"
            />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <x-widget
                ...
                value="{{ showAmount($widget['last7days_invest']) }}"
                bg="success"
            />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            ...
            value="{{ showAmount($widget['total_ref_com']) }}"
            bg="primary"
            />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <x-widget
                ...
                value="{{ showAmount($widget['total_binary_com']) }}"
                bg="red"
            />
        </div><!-- dashboard-w1 end -->
    </div><!-- row end-->
