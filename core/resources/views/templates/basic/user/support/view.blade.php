                    ...
                    <div class="card-body">
                        <form method="post" class="disableSubmission" action="{{ route('ticket.reply', $myTicket->id) }}"
                            ...
                            <div class="row justify-content-between">
                                ...
                                <div class="col-md-9">
                                    <button type="button" class="btn btn-dark w-auto btn-sm addAttachment mt-2 mb-3"> <i
                    ...
                    <div class="col-lg-4 col-md-12 removeFileInput">
                        <div class="form-group">
                            <div class="input-group">
                                <input type="file" name="attachments[]" class="form-control support-input" accept=".jpeg,.jpg,.png,.pdf,.doc,.docx" required>
                                <button type="button" class="input-group-text w-auto bg-danger text-white removeFile bg--danger border--danger"><i class="fas fa-times"></i></button>
                            </div>
                        </div>
                    </div>
                `)
