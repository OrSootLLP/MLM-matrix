        ...
        @foreach ($banners as $banner)
            <div class="swiper-slide">
                <div class="banner-container bg-overlay bg_img"
                    data-background="{{ frontendImage('banner', @$banner->data_values->background_image, '1920x850') }}">
                    <div class="container">
                            ...
                            <div class="button-area">
                                ...
                                <div class="button-group">
                                    <a class="custom-button active"
                                        href="{{ __(@$banner->data_values->left_button_link) }}">{{ __(@$banner->data_values->left_button) }}</a>
                                    <a class="custom-button"
                                        href="{{ __(@$banner->data_values->right_button_link) }}">{{ __(@$banner->data_values->right_button) }}</a>
                                </div>
                            </div>
                        </div>
                    </div>
